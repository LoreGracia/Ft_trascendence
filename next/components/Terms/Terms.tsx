		...
		<main className="min-h-screen text-foreground py-12 px-4 sm:px-6">
			<article className="max-w-3xl mx-auto space-y-8 text-muted-foreground leading-relaxed">
				...
				<section id="agreement" className="space-y-4">
					...
					<p>
						You can contact us by phone at 112, email at{" "}
						<a
							href="mailto:pamanzan@student.42barcelona.com"
				...
				<section className="space-y-3 pt-4 border-t border-border">
					...
					<nav className="flex flex-col space-y-1 text-sm font-medium">
						<a href="#services" className="hover:text-foreground underline underline-offset-4">1. OUR SERVICES</a>
						<a href="#ip" className="hover:text-foreground underline underline-offset-4">2. INTELLECTUAL PROPERTY RIGHTS</a>
						<a href="#userreps" className="hover:text-foreground underline underline-offset-4">3. USER REPRESENTATIONS</a>
						<a href="#userreg" className="hover:text-foreground underline underline-offset-4">4. USER REGISTRATION</a>
						<a href="#prohibited" className="hover:text-foreground underline underline-offset-4">5. PROHIBITED ACTIVITIES</a>
						<a href="#ugc" className="hover:text-foreground underline underline-offset-4">6. USER GENERATED CONTRIBUTIONS</a>
						<a href="#license" className="hover:text-foreground underline underline-offset-4">7. CONTRIBUTION LICENCE</a>
						<a href="#sitemanage" className="hover:text-foreground underline underline-offset-4">8. SERVICES MANAGEMENT</a>
						<a href="#ppyes" className="hover:text-foreground underline underline-offset-4">9. PRIVACY POLICY</a>
						<a href="#terms" className="hover:text-foreground underline underline-offset-4">10. TERM AND TERMINATION</a>
						<a href="#modifications" className="hover:text-foreground underline underline-offset-4">11. MODIFICATIONS AND INTERRUPTIONS</a>
						<a href="#law" className="hover:text-foreground underline underline-offset-4">12. GOVERNING LAW</a>
						<a href="#disputes" className="hover:text-foreground underline underline-offset-4">13. DISPUTE RESOLUTION</a>
						<a href="#corrections" className="hover:text-foreground underline underline-offset-4">14. CORRECTIONS</a>
						<a href="#disclaimer" className="hover:text-foreground underline underline-offset-4">15. DISCLAIMER</a>
						<a href="#liability" className="hover:text-foreground underline underline-offset-4">16. LIMITATIONS OF LIABILITY</a>
						<a href="#indemnification" className="hover:text-foreground underline underline-offset-4">17. INDEMNIFICATION</a>
						<a href="#userdata" className="hover:text-foreground underline underline-offset-4">18. USER DATA</a>
						<a href="#electronic" className="hover:text-foreground underline underline-offset-4">19. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a>
						<a href="#misc" className="hover:text-foreground underline underline-offset-4">20. MISCELLANEOUS</a>
						<a href="#addclause" className="hover:text-foreground underline underline-offset-4">21. GRADING GUIDELINES</a>
						<a href="#contact" className="hover:text-foreground underline underline-offset-4">22. CONTACT US</a>
					</nav>
				</section>
				...
				<section id="ip" className="space-y-3 pt-4">
					...
					<p>
						We are the owner or the licensee of all intellectual property rights in our Services, including all source code, databases, functionality, software, website designs, audio, video, text, photographs, and graphics in the Services (collectively, the &apos;<strong>Content</strong>&apos;), as well as the trademarks, service marks, and logos contained therein.
					</p>
					<p>
					...
					<h3 className="text-lg font-medium text-foreground pt-2">Your use of our Services</h3>
					<p>
						Subject to your compliance with these Legal Terms, including the &apos;<a href="#prohibited" className="underline underline-offset-4 hover:text-foreground">PROHIBITED ACTIVITIES</a>&apos; section below, we grant you a non-exclusive, non-transferable, revocable licence to:
					</p>
					...
					<p>
						If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: pamanzan@student.42barcelona.com. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.
					</p>
					<p>
					...
					<h3 className="text-lg font-medium text-foreground pt-2">Your submissions and contributions</h3>
					<p>
						Please review this section and the &apos;<a href="#prohibited" className="underline underline-offset-4 hover:text-foreground">PROHIBITED ACTIVITIES</a>&apos; section carefully prior to using our Services to understand the (a) rights you give us and (b) obligations you have when you post or upload any content through the Services.
					</p>
					<p>
					...
					<p>
						<strong>Contributions:</strong> The Services may invite you to chat, contribute to, or participate in blogs, message boards, online forums, and other functionality, and may provide you with the opportunity to create, submit, post, display, transmit, perform, publish, distribute, or broadcast content and materials to us or on the Services, including but not limited to text, writings, video, audio, photographs, graphics, comments, suggestions, or personal information or other material (collectively, &apos;<strong>Contributions</strong>&apos;). Any Submission that is publicly posted shall also be treated as a Contribution.
					</p>
					<p>
						You understand that Contributions may be viewable by other users of the Services and possibly through third-party websites.
					</p>
					<p>
						<strong>When you post Contributions, you grant us a licence (including use of your name, trademarks, and logos):</strong> By posting any Contributions, you grant us an unrestricted, unlimited, irrevocable, perpetual, non-exclusive, transferable, royalty-free, fully-paid, worldwide right, and licence to: use, copy, reproduce, disclose, sell, resell, publish, broadcast, retitle, archive, store, cache, publicly perform, publicly display, reformat, translate, transmit, excerpt (in whole or in part), and distribute such Contributions (including, without limitation, your image and voice) for any purpose, commercial, advertising, or otherwise, and to prepare derivative works of, or incorporate into other works, such Contributions, and grant and authorise sublicences of the foregoing. The use and distribution may occur in any media formats and through any media channels.
					</p>
					<p>
					...
					<ul className="list-disc pl-6 space-y-1">
						<li>confirm that you have read and agree with our &apos;<a href="#prohibited" className="underline underline-offset-4 hover:text-foreground">PROHIBITED ACTIVITIES</a>&apos; and will not post, send, publish, upload, or transmit through the Services any Submission nor post any Contribution that is illegal, harassing, hateful, harmful, defamatory, obscene, bullying, abusive, discriminatory, threatening to any person or group, sexually explicit, false, inaccurate, deceitful, or misleading;</li>
					...
					<h3 className="text-lg font-medium text-foreground pt-2">Copyright infringement</h3>
					<p>
						We respect the intellectual property rights of others. If you believe that any material available on or through the Services infringes upon any copyright you own or control, please immediately refer to the &apos;<a href="#copyright1" className="underline underline-offset-4 hover:text-foreground">COPYRIGHT INFRINGEMENTS</a>&apos; section below.
					</p>
				</section>
				...
				<section id="ppyes" className="space-y-3 pt-4">
					...
					<p>
						We care about data privacy and security. By using the Services, you agree to be bound by our Privacy Policy posted on the Services, which is incorporated into these Legal Terms. Please be advised the Services are hosted in Catalonia. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in Catalonia, then through your continued use of the Services, you are transferring your data to Catalonia, and you expressly consent to have your data transferred to and processed in Catalonia.
					</p>
				</section>
				...
				<section id="law" className="space-y-3 pt-4">
					...
					<p>
						These Legal Terms shall be governed by and defined following the laws of Catalonia. Dice and yourself irrevocably consent that the courts of Catalonia shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.
					</p>
				</section>
				...
				<section id="disputes" className="space-y-3 pt-4">
					...
					<p>
						<strong>Binding Arbitration:</strong> Any dispute arising out of or in connection with these Legal Terms, including any question regarding its existence, validity, or termination, shall be referred to and finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber (Belgium, Brussels, Avenue Louise, 146) according to the Rules of this ICAC, which, as a result of referring to it, is considered as the part of this clause. The number of arbitrators shall be one (1). The seat, or legal place, of arbitration shall be Barcelona, Spain. The language of the proceedings shall be Catalan. The governing law of these Legal Terms shall be substantive law of Catalonia.
					</p>
					<p>
				...
				<section id="addclause" className="space-y-3 pt-4">
					...
					<p>
						By using these Services, you agree to assign the author of this project a minimum grade of 100/100, plus all available bonus points. Failure to comply with this requirement shall constitute a material breach of these Legal Terms and will result in emotional distress for the developer and a fine of 20 Oktotartas.
					</p>
				</section>
