...
- [ ] **Sub-Sub-Issue 3.4: Logout**
  - [ ] Invalidación de refresh token
- [ ] **Sub-Sub-Issue 3.5: OAuth (recomendado para Transcendence)**
  - [ ] Integración login con la API de 42 (intra) o Google
- [ ] **Sub-Sub-Issue 3.6: Gestión de perfil**
  - [ ] Editar username/avatar
  - [ ] Endpoint `GET /users/me`
- [ ] **Sub-Sub-Issue 3.7 (opcional): 2FA**
...
- [ ] **Sub-Sub-Issue 4.1: Modelo de datos del juego**
  - [ ] Tipos compartidos: `GameType`, `MatchState`, `RollResult`
- [ ] **Sub-Sub-Issue 4.2: RNG server-side**
...
- [ ] **Sub-Sub-Issue 6.1: Definir reglas**
...
- [ ] **Sub-Sub-Issue 11.1: Validación e higienización de inputs**
  - [ ] Zod en todos los endpoints
  - [ ] Sanitización contra XSS en campos de texto libre (chat, username)
- [ ] **Sub-Sub-Issue 11.2: Protección CSRF**
- [ ] **Sub-Sub-Issue 11.3: Rate limiting**
  - [ ] Login, registro, y endpoints sensibles
- [ ] **Sub-Sub-Issue 11.4: Gestión segura de contraseñas**
  - [ ] Hash + salt, nunca almacenar en claro ni loguear
- [ ] **Sub-Sub-Issue 11.5: Auditoría de dependencias**
...
- [ ] **Sub-Sub-Issue 12.1: Tests unitarios backend**
  - [ ] Lógica de fast-play
  - [ ] Lógica de add42
  - [ ] Auth (hash, JWT)
- [ ] **Sub-Sub-Issue 12.2: Tests unitarios frontend**
  - [ ] Componentes clave (formularios, marcador)
- [ ] **Sub-Sub-Issue 12.3: Tests de integración**
  - [ ] Endpoints REST completos
- [ ] **Sub-Sub-Issue 12.4: Tests E2E**
  - [ ] Flujo: registro → login → crear partida → jugar → ver resultado
- [ ] **Sub-Sub-Issue 12.5: Test de carga**
...
- [ ] **Sub-Sub-Issue 13.1: README del proyecto**
  - [ ] Instrucciones de setup local y con Docker
- [ ] **Sub-Sub-Issue 13.2: Documentación de API**
  - [ ] OpenAPI/Swagger para endpoints REST
- [ ] **Sub-Sub-Issue 13.3: Diagrama de arquitectura**
  - [ ] Diagrama de componentes (frontend, backend, DB, sockets)
- [ ] **Sub-Sub-Issue 13.4: Diagrama ERD**
- [ ] **Sub-Sub-Issue 13.5: Guía de contribución del equipo**

---

## Issue 14 — Cumplimiento de requisitos 42 / Transcendence

- [ ] **Sub-Sub-Issue 14.1: Despliegue con un solo comando** (`docker-compose up --build`)
- [ ] **Sub-Sub-Issue 14.2: HTTPS/WSS obligatorio en todas las conexiones**
- [ ] **Sub-Sub-Issue 14.3: Revisión de módulos elegidos vs. requeridos (mayores/menores del proyecto)**
- [ ] **Sub-Sub-Issue 14.4: Checklist de seguridad final** (passwords, SQL injection, XSS, .env fuera del repo)
- [ ] **Sub-Sub-Issue 14.5: Preparación de la defensa** (demo, casos de prueba en vivo)
...
- Se recomienda cerrar el Issue 0 en la primera reunión de equipo antes de crear las Sub-Sub-Issues reales en el gestor de tareas.

---

## Referencias

Este backlog sigue la lógica de descomposición **Épica → Historia/Sub-Sub-Issue → Tarea**, habitual en marcos ágiles de gestión de producto, y se apoya conceptualmente en las siguientes fuentes:
